	  ...
	  <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
		<form class="modal-content" action="saveprofile.do" method="post">
		      ...
		      <hr>
				...
				<br><b>Address</b> <input type="text" name="address1" size="40">
				<br><b>Date Of Birth</b><input type="date" name="date" >
				<br><b>Gender</b> <br>
				<br><label class="container22">Male
				  <input type="radio" name="gender" value="M" checked>
				  <span class="checkmark"></span>
				</label>
				<label class="container22">Female
				  <input type="radio" name="gender" value="F">
				  <span class="checkmark"></span>
				</label>
				   
				<br><b>Phone No</b> <input type="text" name="phno">
				<br><b>Email</b> <input type="text" name="email" >
				<br><b>About Me</b> <textarea name="remarks"></textarea>
		      <div class="clearfix">
